...
const GOOGLE_SHEET_URL = 'https://script.google.com/macros/s/AKfycbyt6QtsvC-woc1-ojO1kkddJjiv3DKigT-KzKo-zbVnjcwfiGMz-qUhhDxI70-cEEwdyQ/exec';
// Example: 'https://script.google.com/macros/s/AKfycb.../exec'
const SECRET_TOKEN = ''; // keep empty for now (Apps Script SECRET_TOKEN is blank). Set a token later for protection.
...
if (form) {
  form.addEventListener('submit', async function(e) {
    ...
    if (GOOGLE_SHEET_URL && GOOGLE_SHEET_URL !== 'YOUR_GOOGLE_APPS_SCRIPT_URL_HERE') {
      try {
        // Use GET no-cors fallback to ensure compatibility with Apps Script web app without CORS headers.
